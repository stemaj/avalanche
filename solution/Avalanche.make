...
MAKEFILE = Avalanche.make

ifeq ($(config),debug)
  OBJDIR              = obj/Debug
  TARGETDIR           = bin/Debug
  TARGET              = $(TARGETDIR)/Avalanche
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -std=c++20
  ...
  OBJECTS := \
	...
	$(OBJDIR)/olcTemplate/game/src/render/src/renderCutscene.o \
	$(OBJDIR)/olcTemplate/game/src/room3d.o \
	$(OBJDIR)/olcTemplate/game/src/sound.o \
	$(OBJDIR)/olcTemplate/game/src/state/src/cutscene.o \
...
ifeq ($(config),release)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -O3 -std=c++20
...
ifeq ($(config),debug64)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -m64 -std=c++20
...
ifeq ($(config),release64)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -O3 -m64 -std=c++20
...
ifeq ($(config),debuguniv64)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -g -arch x86_64 -arch ppc64 -std=c++20
...
ifeq ($(config),releaseuniv64)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -O3 -arch x86_64 -arch ppc64 -std=c++20
...
$(OBJDIR)/olcTemplate/game/src/render/src/renderCutscene.o: ../olcTemplate/game/src/render/src/renderCutscene.cpp $(GCH) $(MAKEFILE) | $(OBJDIR)/olcTemplate/game/src/render/src
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -c "$<"
...
$(OBJDIR)/olcTemplate/game/src/state/src/cutscene.o: ../olcTemplate/game/src/state/src/cutscene.cpp $(GCH) $(MAKEFILE) | $(OBJDIR)/olcTemplate/game/src/state/src
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -c "$<"
